...
- Repeated calibration of the same detection set from `1.02` through `1.14125` improved public score monotonically, but future steps are very close to the score upper bound.
