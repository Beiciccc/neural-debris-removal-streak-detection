...
| 18 | `sub18_zaoui_public_scale112_keep020.csv` | `249.5353` | Same detection set with confidence scale `1.12`. |
| 19 | `sub19_zaoui_public_scale11225_keep020.csv` | `249.5342` | Same detection set with confidence scale `1.1225`. |
...
- Repeated calibration of the same detection set from `1.02` through `1.1225` improved public score monotonically, but the marginal gain is now very small.
