...
| File | Public score |
| --- | ---: |
| `submissions/sub20_zaoui_public_scale1125_keep020.csv` | `246.8721` |
...
```bash
python3 scripts/validate_submission.py submissions/sub20_zaoui_public_scale1125_keep020.csv
```
