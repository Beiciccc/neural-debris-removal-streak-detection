...
| File | Public score |
| --- | ---: |
| `submissions/sub25_zaoui_public_scale1141_keep020.csv` | `246.8416` |
...
```bash
python3 scripts/validate_submission.py submissions/sub25_zaoui_public_scale1141_keep020.csv
```
