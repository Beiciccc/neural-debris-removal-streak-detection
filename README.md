...
| File | Public score |
| --- | ---: |
| `submissions/sub22_zaoui_public_scale113_keep020.csv` | `246.8615` |
...
```bash
python3 scripts/validate_submission.py submissions/sub22_zaoui_public_scale113_keep020.csv
```
